...
function Matches() {
  ...
  const loadData = () => {
    axios.get('http://localhost:8060/api/matches').then((resp) => {
      setMatches(resp.data)
    })
    axios.get('http://localhost:8060/api/teams').then((resp) => {
      setteams(resp.data)
    })
  }
  ...
  const handleDelete = (id) => {
    axios
      .delete('http://localhost:8060/api/matches/' + id)
      .then((resp) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post('http://localhost:8060/api/matches', {
        team1: teamOne,
        team2: teamTwo,
      })
      .then((resp) => {
